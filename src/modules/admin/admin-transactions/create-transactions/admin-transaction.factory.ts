...
export class AdminTransactionFactory {
    ...
    static getTransactionType(
        ...
        switch(createAdminTransactionDto.type){
            case(AdminTransactionType.OSMO_DEBIT): return new OsmoDebit(entityManager,createAdminTransactionDto, ibexService)
            case(AdminTransactionType.OSMO_CREDIT): return new OsmoCredit(entityManager,createAdminTransactionDto, ibexService)
            case(AdminTransactionType.LIQUIDITY_SELL): return new LiquiditySell(entityManager,createAdminTransactionDto)
            case(AdminTransactionType.LIQUIDITY_BUY): return new LiquidyBuy(entityManager,createAdminTransactionDto)
            default:
                throw new Error("")
        } 
    } 
