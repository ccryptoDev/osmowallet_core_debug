import { EmailContentStructure, EmailFromStructure, EmailToStructure, SendgridTemplate } from "./sendgridBase.template";

/*
    This class send email verification to the user extending of base class
 */
export class SystemErrorTemplate extends SendgridTemplate {
    ...
    constructor(
        ...
        this.subject = 'Error en el sistema'
