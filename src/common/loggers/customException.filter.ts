...
export class CustomExceptionFilter implements ExceptionFilter {
  ...
  constructor(
    ...
    if (user instanceof AuthUser) {
      userId = user['sub']
      email = user['email' as keyof AuthUser]
    }
    if (error instanceof Error) {
      ...
      if (this.blacklistRoutes[request.url as keyof typeof this.blacklistRoutes] === undefined || !(error instanceof UnauthorizedException))
